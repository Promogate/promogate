  ...
  return (
    <>
      ...
      <Box as='main' maxWidth={{ xl: '1170px' }} margin={'0 auto'}>
        <Heading fontSize={{ xl: '5rem' }} fontFamily={montserrat.style.fontFamily} marginTop={{ xl: '32px' }}
        ...
        <Grid gridTemplateColumns={{ xl: '1fr 1fr' }}>
          ...
          <Flex flexDirection={'column'} alignSelf={'center'} justifyContent={'center'} height={'100%'}>
            <Heading fontSize={{ xl: '2rem' }} fontFamily={montserrat.style.fontFamily} color={'#2b2b2b'} >
        ...
        <Box margin={{ xl: '0 auto' }} maxWidth={{ xl: '900px' }}>
          <Heading fontSize={{ xl: '3rem' }} fontFamily={montserrat.style.fontFamily} marginTop={{ xl: '32px' }}
            color={'#2b2b2b'}>
        ...
        <Box margin={{ xl: '104px auto 0 auto' }} maxWidth={{ xl: '900px' }}>
          <Heading fontSize={{ xl: '3rem' }} fontFamily={montserrat.style.fontFamily} marginTop={{ xl: '32px' }}
            color={'#2b2b2b'}>
            FAQ
          </Heading>
          <Accordion margin={{ xl: '2rem 0' }} maxWidth={{ xl: '900px' }} allowToggle>
            <AccordionItem>
              <AccordionButton>
                <Box as='span' flex={'1'} textAlign={'left'} fontFamily={montserrat.style.fontFamily}
                  fontSize={{ xl: '1.2rem' }} fontWeight={'medium'}>
